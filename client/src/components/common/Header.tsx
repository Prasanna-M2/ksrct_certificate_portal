      ...
      <div className="flex items-center justify-between px-4 lg:px-8 py-2.5">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <Link to="/dashboard" className="flex items-center gap-3 cursor-pointer group select-none">
            <div className="w-10 h-10 rounded-xl bg-white p-1 flex items-center justify-center shadow-xs transition-transform group-hover:scale-105 border border-slate-200">
              <img
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:flex items-center gap-1.5 px-3 py-1 text-[11px] font-bold text-[#f37021] bg-orange-50 border border-orange-200 rounded-full">
            <ShieldCheck className="w-3.5 h-3.5 text-[#f37021]" />
            <span>KSRCT Verified Portal</span>
          </div>
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-2xl border border-slate-200 shadow-xl z-50 p-4 space-y-3 animate-scale-in">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2.5 p-1.5 pr-3 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 transition-all cursor-pointer shadow-xs"
            >
            ...
            {showProfileMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-slate-200 z-50 p-2 space-y-1 animate-scale-in">
